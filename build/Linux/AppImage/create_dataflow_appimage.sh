...
exec "${HERE}/usr/share/dataflow/venv/bin/python" "${HERE}/usr/share/dataflow/dataflow.py" "$@"
EOF
...
check_file_exists "$APPDIR/usr/share/dataflow/dataflow.py" "Script principale"

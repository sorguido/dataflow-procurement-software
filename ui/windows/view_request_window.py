...
Estratta da DataFlow 2.0.0.py per migliore organizzazione del codice.
"""
...
class ViewRequestWindow(tk.Toplevel):
    ...
    def open_notes_window(self):
        ...
        # Trova il percorso del file principale
        main_file = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'DataFlow 2.0.0.py')
        ...
        win = dataflow_main.NotesWindow(self, self.request_id)
    ...
    def open_sqdc_analysis(self):
        ...
        dataflow_main = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(dataflow_main)
        SQDCAnalysisWindow = dataflow_main.SQDCAnalysisWindow
    ...
    def open_edit_reference_window(self):
        ...
        dataflow_main = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(dataflow_main)
        EditReferenceWindow = dataflow_main.EditReferenceWindow
    ...
    def open_po_window(self):
        ...
        dataflow_main = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(dataflow_main)
        PurchaseOrderWindow = dataflow_main.PurchaseOrderWindow
    ...
    def open_edit_suppliers_window(self):
        ...
        dataflow_main = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(dataflow_main)
        EditSuppliersWindow = dataflow_main.EditSuppliersWindow
    ...
    def open_attachment_window(self, attachment_type):
        ...
        dataflow_main = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(dataflow_main)
        AttachmentWindow = dataflow_main.AttachmentWindow
